...
​
## 🎯 Autoavaliação
Conceito pretendido: [ D ]
​
Justificativa (cite arquivo e linha de cada critério):
- O jogo funciona ............: par_impar.py, linhas __ a __
- Funções e operador % .......: par_impar.py, linha __  (def/return, soma % 2)
- Documentação e Git .........: este README + commits no GitHub
- Extensão/originalidade .....: par_impar.py, linha __  (o que eu criei — níveis B/A)
​
