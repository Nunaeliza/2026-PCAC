...
#                e o resto da divisão (%) para guardar o que SOBROU para próxima troca
...
n01  = n //   1;  n = n %  1     # quantas notas de   1 cabem no que sobrou 

# decomposição de CENTAVOS em moedas - mesma lógica, agora em centavos
...
# Saída formatada - exatamente como o juíz online espera (cuidado com a grafia!)
print('NOTAS:')
print(f'{n100} nota(s) de R$ 100.00')
print(f'{n50} nota(s) de R$ 50.00')
print(f'{n20} notas(s) de R$ 20.00')
