...
# Disciplina  : Pensamento Computacional, Algoritimos e Programação (2026-PCAP)
...
def cadastrar(jogadores):
    ...
    print("Jogador " + apelido + " cadatrado.")
    linha()
...
def excluir(jogadores):
    """
    Você escolhe um apelido ou nome de um jogador.

    Ele vai excluir esse jogador.
    """
    listar(jogadores)
    ...
    if i == -1:
        ...
        print("Vou pegar o cadastro de " + jogadores[i][1] + ".")
        print("[1] Confirmar")
